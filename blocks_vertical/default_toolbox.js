...
Blockly.Blocks.defaultToolbox = '<xml id="toolbox-categories" style="display: none">' +
  ...
  '<category name="Extensions" id="extensions" colour="#FF6680" secondaryColour="#FF4D6A" ' +
    ...
    '<block type="extension_microbit_display" id="extension_microbit_display">' +
      ...
      '</value>' +
    '</block>' +
    '<block type="extension_pingpong_display" id="extension_pingpong_display">' +
      '<value name="MATRIX8">' +
        '<shadow type="matrix8">' +
          '<field name="MATRIX8">1000000001000000001000000001000000000000000000000000000000000000</field>' +
        '</shadow>' +
      '</value>' +
    '</block>' +
